import {
    StyledFooter,
    FooterList,
    FooterListItem, FooterListImageItem, FooterRights, FooterContent, LogoContainer
    ...
    return (
        <StyledFooter>
            <FooterContent>
                ...
                <FooterList>
                    <FooterListImageItem><Image src={facebookLogo} alt='reddit logo' /></FooterListImageItem>
                    <FooterListImageItem><Image src={twitterLogo} alt='twitter logo' /></FooterListImageItem>
                    <FooterListImageItem><Image src={youtubeLogo} alt='youtube logo' /></FooterListImageItem>
                </FooterList>
                <FooterRights>
                    <LogoContainer>
