...
export default function Description() {
  ...
  return (
    <DescriptionSection>
      <DescTitle>
        Machine learning made <GreenSpan>easy</GreenSpan>
      </DescTitle>
      <DescriptionDetails>
        ...
        automatically trains a custom machine learning model that can be shipped
        in your app.
      </DescriptionDetails>
      <DescScreenShootCont>
        {windowWidth! < breakPoint && (
          <DescScreenShoot src={screenShot} alt="screenshot" />
        )}
        {windowWidth! >= breakPoint && (
          <DescScreenShoot src={screenShot2x} alt="screenshot" />
        )}
      </DescScreenShootCont>
      <DescDetailsContainer>
        <DescDetailContainer>
          ...
          <div>
            ...
            <DescriptionItem>
              {" "}
              Use Designed to be easy enough for anyone to use. No code or
              experience required.
            </DescriptionItem>
          </div>
        </DescDetailContainer>
      ...
      <DescDetailsSubTitle>
        <GreenSpan>Project </GreenSpan>Templates
      </DescDetailsSubTitle>
      <DescriptionDetails>
