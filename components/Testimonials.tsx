...
export default function Testimonials() {
    return (
        <TestimonialsContainer>
            <TestimonialCard descText={"As soon as I used Lobe I was completely blown away. I don’t have to spend days trying to learn machine learning. Simply label some images and boom, it really just works."} name={'Chris Cachor'} job={"Software Engineer"} avatar={avatar1} />
