...
import {
  ...
  IntroVideoContainer,
  FirstVideo,
} from "../styles/IntroductionStyles";
    ...
    <IntroSection>
      <IntroVideoContainer>
        {windowWidth! < firstBreakPoint && (
          ...
          >
            <source src="videos/HomeMobile.mp4" type="video/mp4" />
          </FirstVideo>
        )}
        {windowWidth! >= firstBreakPoint && (
          <FirstVideo
      ...
      <IntroSecond>
        <IntroSecondTitle>
          Train apps to
          <IntroSecondGreen fadeState={fadeState}>
            {animatedText}
          </IntroSecondGreen>
        </IntroSecondTitle>
        <IntroSecondDesc>
          Create machine learning methods with a free, easy to use tool.
        </IntroSecondDesc>
        <IntroSecondButtonGrup>
          <IntroDownloadButton>Download</IntroDownloadButton>
          <IntroWatchButton>
            Watch Tour <Image src={logo} alt="play button" />
          </IntroWatchButton>
        </IntroSecondButtonGrup>
      </IntroSecond>
    </IntroSection>
