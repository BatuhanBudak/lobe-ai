  ...
  return (
    <PlantsSection>
      ...
      <ContentContainer>
        <PlantsVideoContainer>
          {windowWidth! < firstBreakPoint && (
            <Video
              ...
              autoPlay
              muted
              title="Quickly label images in Lobe by selecting an image, then typing or selecting a label."
            >
              {" "}
              <source src="/videos/playmobile.mp4" type="video/mp4" />
            </Video>
          )}
          {windowWidth! >= firstBreakPoint && (
            <Video
        ...
        <TextContainer>
          <DescSubTitle>
            <GreenSpan>Label</GreenSpan> your images
          </DescSubTitle>
          <DescriptionDetails>
      ...
      <ContentContainer>
        <PlantsVideoContainer>
          {windowWidth! < firstBreakPoint && (
            <Video
              playsInline
              autoPlay
              title="Once you've added and labeled images, Lobe will automatically start training and showing the predicted label for each image."
            >
              <source src="/videos/trainmobile.mp4" type="video/mp4" />
            </Video>
          )}
          {windowWidth! >= firstBreakPoint && (
            <Video
        ...
        <TextContainer>
          <DescSubTitle>
            <GreenSpan>Train</GreenSpan> automatically
          </DescSubTitle>
          <DescriptionDetails>
        ...
        <PlantsVideoContainer>
          {windowWidth! < firstBreakPoint && (
            <Video
              ...
              autoPlay
              muted
              title="Finally, you can add image to Lobe from your computer, or use your webcam to get predictions in real-time for images your model has never seen. Mark them correct or incorrect to add them to your dataset."
            >
              <source src="/videos/labelmobile.mp4" type="video/mp4" />
            </Video>
          )}
          {windowWidth! >= firstBreakPoint && (
            <Video
              ...
              title="Finally, you can add image to Lobe from your computer, or use your webcam to get predictions in real-time for images your model has never seen. Mark them correct or incorrect to add them to your dataset."
            >
              <source src="/videos/Label.mp4" type="video/mp4" />
            </Video>
          )}
        </PlantsVideoContainer>
        <TextContainer>
          <DescSubTitle>
            <GreenSpan>Use</GreenSpan> your model
          </DescSubTitle>
          <DescriptionDetails>
